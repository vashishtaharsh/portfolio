  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        I'm a skilled Full Stack Web Developer with experience in JavaScript and expertise in frameworks like React.js, Node.js and I have done databse expertise in MongoDB, MySQL.
